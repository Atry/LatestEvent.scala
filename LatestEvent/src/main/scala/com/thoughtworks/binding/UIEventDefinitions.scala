...
private[binding] trait UIEventDefinitions {
  def load(eventTarget: Window) = new LatestEvent[UIEvent | Event](eventTarget, "load")
  def load(eventTarget: Document) = new LatestEvent[UIEvent | Event](eventTarget, "load")
  def load(eventTarget: Element) = new LatestEvent[UIEvent | Event](eventTarget, "load")
  def unload(eventTarget: Window) = new LatestEvent[UIEvent | Event](eventTarget, "unload")
  def unload(eventTarget: Document) = new LatestEvent[UIEvent | Event](eventTarget, "unload")
  def unload(eventTarget: Element) = new LatestEvent[UIEvent | Event](eventTarget, "unload")
  def abort(eventTarget: Window) = new LatestEvent[UIEvent | Event](eventTarget, "abort")
  def abort(eventTarget: Element) = new LatestEvent[UIEvent | Event](eventTarget, "abort")
  def error(eventTarget: Window) = new LatestEvent[UIEvent | Event](eventTarget, "error")
  def error(eventTarget: Element) = new LatestEvent[UIEvent | Event](eventTarget, "error")
  def select(eventTarget: Element) = new LatestEvent[UIEvent | Event](eventTarget, "select")
